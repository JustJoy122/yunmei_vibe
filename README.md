...
# <image src="assets/yunmei-static-transparent.svg" height="28" width="28"/> 云莓氛围
...
- [更新日志](CHANGELOG.md)：v0.1.0-v0.3.9为历史回填，v0.4.0 开始为 git tag
- [开发相关](docs/DEVELOPMENT.md)：技术栈、软件运行要求、构建说明、项目结构、兼容性
...
- 本项目基于 [GNU General Public License v3.0](LICENSE.txt) 获得许可，并使用该许可证开源
...
- Android、DeepSeek、云莓智能，以及本项目提及的其他品牌名称、产品名称、服务名称、商标、标识与图形，均可能为其各自权利人所有的商标或注册商标
