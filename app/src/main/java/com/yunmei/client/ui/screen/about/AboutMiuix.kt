...
import com.yunmei.client.ui.component.miuix.effect.BgEffectBackground
import com.yunmei.client.ui.component.miuix.effect.ColorBlendToken
    ...
    BgEffectBackground(
        ...
        Column(
            ...
            Box(
                ...
                // InstallerX Miuix 关于页 Logo：无外框、无卡片背景，
                // 用 ic_launcher_monochrome 作为蒙版直接融合进全局彩虹/玻璃背景。
                if (enableBlur) {
                    Image(
