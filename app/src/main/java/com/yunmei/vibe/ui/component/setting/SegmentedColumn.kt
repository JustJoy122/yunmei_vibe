...
// Reused verbatim from InstallerX Revived (ui/page/main/widget/setting/SegmentedColumn.kt)
// per project UI reference policy.
// 仅改包名，并将 InstallerX 主题常量 CornerRadius / ConnectionRadius（ui/theme/Shape.kt）内联为本项目等值常量。
...
/** InstallerX `ui/theme/Shape.kt` 中的 CornerRadius / ConnectionRadius 等值常量。 */
