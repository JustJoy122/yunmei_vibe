...
// ui/page/miuix/settings/preferred/about/ossLicensePage/LibrariesContainer.kt
// 仅改包名。颜色全部走 MiuixTheme.colorScheme / MiuixTheme.textStyles，
// 因此自动适配「开启莫奈取色」与「未开启莫奈」两套色板，无需也不得另行分支。
...
@Composable
fun MiuixLibrariesContainer(modifier: Modifier = Modifier, contentPadding: PaddingValues, libraries: Libs?) {
